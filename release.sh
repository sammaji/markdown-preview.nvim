...
GH_REPO="$GH_API/repos/sammaji/markdown-preview.nvim"
...
do
  GH_ASSET="https://uploads.github.com/repos/sammaji/markdown-preview.nvim/releases/$id/assets?name=$filename"
